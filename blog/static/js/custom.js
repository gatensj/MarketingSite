            ...
            if (!$('body').hasClass('no-animate')) {
                ...
                if ($(".animsition-overlay").length) {
                    ...
                    $(".animsition-overlay").animsition({
                        ...
                        linkElement: 'a:not([target="_blank"]):not([href^=\\#]):not([href^="ajax"]):not([class*="header-links"]):not([class*="mag-popup"]):not([class*="ajax"]):not([class*="showhide"]):not([href^="javascript"]):not([class^="bx"]):not([class^="standard-popup"]):not([class*="mag-lightbox"]):not([data-popup]):not([class*="header-video__play-trigger"])',
                        loading: true,
